...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-themecolor"><i class="fa fa-money"></i> Lương thưởng
      </h3>
    </div>
    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Lương
        </li>
      </ol>
    </div>
  </div>
      ...
      <div class="col-12">
        <div class="card card-outline-info">
          <div class="card-header">
            <h4 class="m-b-0 text-white"> Danh sách lương theo tháng
            </h4>
          </div>
          <div class="card-body">
            <!--Savd vdgff gdfg dfg dfgdfg df  gd gdd gfd-->
                <div class="row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <button style="float:left;margin-top:23px" type="submit" id="BtnSubmit" class="btn btn-success">Lưu</button>          
                     </div>
                                </form>
                            </div>
                        </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
          <div class="modal-header">
            <h4 class="modal-title" id="">Chế độ lương
            </h4>
          ...
          <form method="post" action="pay_salary_add_record" id="generatePayrollForm" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group row" id="addition">
                <label class="control-label text-left col-md-5">Thêm
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Ngày trả
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row" id="loan">
                <label class="control-label text-left col-md-5">Nợ
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Lương cuối cùng
                </label>
                <div class="col-md-7">
              ...
              <!--<div class="form-group row" style="margin-top: 25px;">
                ...
                <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="paid_type" required>
                  ...
                  <option value="Bank">Bank
                                ...
                                <div class="form-group row" style="margin-top: 25px;">
                                    <label class="control-label text-left col-md-3">Loại trả</label><br>
                                    <div class="col-md-9">
