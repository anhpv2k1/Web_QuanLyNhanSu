         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-bars" aria-hidden="true"></i> Lương</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Trang chủ</a></li>
                        <li class="breadcrumb-item active"><i class="fa fa-university" aria-hidden="true"></i> Lương</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-hourglass-start" aria-hidden="true"></i>Danh sách lương                  
                                </h4>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Hình thức tiền lương</h4>
...
<!--			                                    <div class="form-group">
                                            ...
                                            <h4>Bổ sung</h4>                                         
                                            <div class="form-group">
                                                <label class="control-label">Y khoa</label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Tiền bảo hiểm</label>
