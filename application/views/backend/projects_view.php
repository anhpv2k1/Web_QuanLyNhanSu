                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#office" role="tab">Các nhiệm vụ công ty </a> </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Ngày bắt đầu </small>
                                ...
                                <div class="tab-pane" id="tasks" role="tabpanel">
                                    <div class="card">
				                        <div class="card-body">
			                        		<h3 class="card-title">Tasks kế hoạch</h3>                   
                            ...
                            <tbody>
                               <?php foreach($tasklist as $value): ?>
                                ...
                                <div class="tab-pane" id="office" role="tabpanel">
                                    <div class="card">
				                        <div class="card-body">
			                        		<h3 class="card-title">Các nhiệm vụ công ty</h3>
                            ...
                            <tbody>
                               <?php foreach($tasklist as $value): ?>
                                ...
                                <div class="tab-pane" id="field" role="tabpanel">
                                    <div class="card">
				                        <div class="card-body">
			                        		<h3 class="card-title">Nhiệm vụ hiện trường</h3>
                        <span class="pull-right">
                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>  
                               ...
                               <?php foreach($expenses as $value): ?>
                                ...
                                <?php endforeach; ?>
                                        ...
                                        <form class="row">
                                            ...
                                            <div class="form-group col-md-6 m-t-5">
                                                <label class="">NID Giấy</label>
                                                <input type="file" name="file" class="form-control" required="" aria-invalid="false">
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <button class="btn btn-success">Upload tài liệu</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
