                        ...
                        <div class="card card-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-xs-6 col-sm-6 text-left payslip_address">
                                    ...
                                    <p>
                                        Sđt <?php echo $settingsvalue->contact; ?>, Email: <?php echo $settingsvalue->system_email; ?>
                                    </p>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                                        <thead class="thead-light" style="border: 1px solid #ececec;">
                                            <tr>
                                                <th>Mô tả</th>
                                                <th class="text-right">Nhận được</th>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content ">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLabel1">Form lương</h4>
