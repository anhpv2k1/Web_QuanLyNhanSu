         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>attendance/Attendance" class="text-white"><i class="" aria-hidden="true"></i>  Danh sách điểm danh</a></button>
                    ...
                    <div class="col-6">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"> Điểm danh </h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group" >
                                           <label class="m-t-20">Bắt đầu</label>
                                        ...
                                        <div class="form-group">
                                        <label class="m-t-20">Kết thúc</label>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" data-placeholder="" tabindex="1" name="place" required>
                                                    <option value="office" <?php if(isset($attval->place) && $attval->place == "office") { echo "selected"; } ?>>Công ty</option>
                                                    <option value="field"  <?php if(isset($attval->place) && $attval->place == "field") { echo "selected"; } ?>>Nhà</option>
                                                </select>
                                        </div> 
                                    </div>
