         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>attendance/Save_Attendance" class="text-white"><i class="" aria-hidden="true"></i> Thêm điểm danh </a></button>
                        <button type="button" class="btn btn-info"><a href="<?php echo base_url(); ?>attendance/Attendance_Report" class="text-white"><i class="" aria-hidden="true"></i> Tạo báo cáo điểm danh </a></button>
                    </div>
                </div>  
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Báo cáo điểm danh</h4>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body EmployeeInfo">
                                ...
                                Đã làm <span class="hours"></span> Giờ vào <span class="days"></span> Ngày
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tất cả điểm danh</h4>
