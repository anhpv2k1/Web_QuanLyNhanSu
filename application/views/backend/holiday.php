...
<!--
                ...
                <div class="row m-b-10"> 
                    ...
                    <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>leave/Application" class="text-white"><i class="" aria-hidden="true"></i>  Thêm phiếu nghỉ</a></button>
                        <?php } ?>
                    </div>
                </div>  
                <div class="row">
