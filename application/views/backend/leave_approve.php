...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Ứng dụng</h3>
        </div>
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
            <?php // if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> 
                <div class="col-12">
                    <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#appmodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Thêm phiếu nghỉ </a></button>
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>leave/Holidays" class="text-white"><i class="" aria-hidden="true"></i> Ngày lễ</a></button>
                </div>                       
            <?php // } ?> 
        </div> 
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Danh sách phiếu nghỉ                      
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr style="vertical-align:top">
                                        ...
                                        <td class="jsgrid-align-center">
                                           ...
                                           <?php if($value->leave_status =='Approve'){ ?>
                                            ...
                                            <a href="" title="Edit" class="btn btn-sm btn-success waves-effect waves-light Status" data-employeeId=<?php echo $value->em_id; ?>  data-id="<?php echo $value->id; ?>" data-value="Approve" data-duration="<?php echo $value->leave_duration; ?>" data-type="<?php echo $value->typeid; ?>">Chấp thuận</a>       
                                            <a href="" title="Edit" class="btn btn-sm btn-danger waves-effect waves-light  Status" data-id = "<?php echo $value->id; ?>" data-value="Rejected" >Từ chối</a>
                                            <br> 
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="span pull-right">
                                        <button class="btn btn-info fetchLeaveTotal">Tổng số nghỉ phép</button>
                                    </div>
                                    <br>
                                </div>
                                <div class="form-group">
                                    ...
                                    <label for="radio_2">Nguyên ngày</label>
