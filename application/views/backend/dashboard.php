      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-braille" style="color:#1976d2"></i>&nbsp Bảng điều khiển</h3>
                </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-info">
                            <div class="box bg-primary text-center">
                                ...
                                <h6 class="text-white">Nhân viên xin ứng tuyển</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Dự án đang thực hiện</h4>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Danh sách nhiệm vụ của bạn cần hoàn thành</h6>
                                ...
                                <div class="new-todo">
                                   <form method="post" action="add_todo" enctype="multipart/form-data" id="add_todo" >
                                    <div class="input-group">
                                        <input type="text" name="todo_data" class="form-control" style="border: 1px solid #fff !IMPORTANT;" placeholder="Thêm 1 task">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Bảng ghi chú</h4>
                            </div>
                            <div class="card-body">
